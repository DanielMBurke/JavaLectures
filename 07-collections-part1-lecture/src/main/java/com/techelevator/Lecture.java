...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		Object obj = name;
		//Object nathanObj ="George Washington"
		...
		//if (name == nathanObject) // Returns false because they point to separate location
		//if (name.isequal(nathanObject) // Returns true 

		if(name == obj) {  // True - reference IS to the same memory location
		...
		if(obj.equals("George Washington")) {      // compares content of the objects
		...
		//obj is a Class Obj- toUpperCse is a String Class method
		// obj.toUpperCase(); // this causes a compiler error because toUpperCase is not a valid java.lang.Object method
		
		/* I can cast a super type into a valid subclass in order to treat the variable as an instance of the subclass */
		...
		Double accountBalance = null;    			 //this creates an object that is null or "empty"
		// double newBalance = accountBalance + 100;  // this causes a NullPointerException because we are trying to "unbox" a null value
		
		System.out.println("####################");
		System.out.println("       LISTS");
		System.out.println("####################");
		//List<String> names = new ArrayList<String>();			//new ArrayList of String Objects
		public List<String> array2List(String[] stringArray) {

		ArrayList<String> names = new ArrayList<String>();       //new ArrayList of String Objects
		//object.method(parameters)  <-Standard Syntax 
		...
		names.add(2, "David");  //adds David at index 2
