...
--SELECT * FROM city WHERE district = 'Ohio'; --string values are in 'single quotes'

-- Selecting countries that gained independence in the year 1776
--SELECT * FROM country WHERE indepyear = 1776

     -- <> MEANS NOT EQUAL & = means equals
...
--SELECT * FROM city WHERE district = 'Ohio' AND population > 400000; -- entire condition must be specified before/after the OR/AND
