...
public class LectureTest {
    ...
    Lecture exercises = new Lecture();				//instantiate object with the code to be tested
    ...
    public void testReturnFirstElement() {
        assertEquals("That's not the first element in that array", 0, exercises.returnFirstElement());
    }
