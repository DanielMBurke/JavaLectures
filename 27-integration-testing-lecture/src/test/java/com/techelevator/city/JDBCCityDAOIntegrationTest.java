...
public class JDBCCityDAOIntegrationTest {
	...
	public static void setupDataSource() {
		...
		dataSource.setAutoCommit(false);  // STARTING A TRANSACTION/ unit of work (UOR)
	}
	...
	public void setup() {
		String sqlInsertCountry = "INSERT INTO country (code, name, continent, region, surfacearea, indepyear, "
				...
				+ "code2) VALUES (?, 'Afghanistan', 'Asia', 'Southern and Central Asia', 652090, 1919, 22720000, "
				+ "45.9000015, 5976.00, NULL, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF')";
	...
	public void save_new_city_and_read_it_back() throws SQLException {
		...
		assertNotEquals(null, theCity.getId());		//new city was NOT added
		assertCitiesAreEqual(theCity, savedCity);	//new city WAS added
	}
	@Test
	public void returns_cities_by_country_code() {
		...
		assertNotNull(results);					// At least one city was found
		assertEquals(1, results.size());			// 
		City savedCity = results.get(0);			// get = zero-based index so 0 is the first result here
		assertCitiesAreEqual(theCity, savedCity);// compares the data
	}
