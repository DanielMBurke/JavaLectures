...
--The name and average life expectancy of the countries 
--with the 10 highest life expectancies.
...
FROM city 
WHERE district IN ('California','Oregon','Washington') --IN is alternative to multi OR's
...
--name & surface area of the smallest country 
...
-- Aggregate functions provide the ability to COUNT, SUM, AVG, and determine MIN and MAX.
-- Only returns a single row of value(s).
